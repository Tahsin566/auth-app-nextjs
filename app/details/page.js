...
const Details = () => {
    ...
    useEffect(()=>{
        fetch('https://auth-app-nextjs-ilgbtxael-tahsin566s-projects.vercel.app/api/dashboard').then(res=>res.json()).then(data=>{
    ...
    const handleout = ()=>{
        fetch('https://auth-app-nextjs-ilgbtxael-tahsin566s-projects.vercel.app/api/logout').then(res=>res.json()).then(data=>{
            if(data.logout){
